...
Paulo Coneglian
*/
function sendMail($email, $nome, $assunto, $body, $title)
{
    $mail = new PHPMailer();
    $mail->IsSMTP();
    $mail->CharSet = 'UTF-8';
    ...
    $mail->SMTPDebug = 0;
    $mail->Host = "smtp.promocaosamapi.com.br";
    $mail->Port = 587;
    $mail->SMTPAuth = true;
    $mail->SMTPSecure = '';
    $mail->Username = "sac@promocaosamapi.com.br";
    $mail->Password = "Prosam321";
    $mail->SetFrom('sac@promocaosamapi.com.br', $title);
    $mail->addReplyTo('sac@promocaosamapi.com.br', $title);
    $mail->AddAddress($email, $nome);
    //$mail->AddAddress('paulo@agenciazum.com.br', 'Agência Zum'); /*teste*/
